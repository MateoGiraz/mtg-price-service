from sqlalchemy import create_engine, Column, Integer, String, Double, MetaData, DateTime, Boolean, func
...
class Card(Base):
    ...
    def __init__(self, name, price, edition, foil, timestamp=func.now()):
      self.name = name
